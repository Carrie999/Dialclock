    ...
    var body: some View {
        GeometryReader { geometry in
            ...
            Circle()
                ...
                .shadow(color: Color.black.opacity(0.5), radius: 14, x:5, y: 6) // 向右下方偏移2个单位
...
struct EightSwiftUIView: View {
    ...
    var body: some View {
        ZStack {
        VStack {
            AnalogClockView8(foregroundColor: $themeColor,
...
//            isLandscape = UIDevice.current.orientation.isLandscape
        ...
        .onAppear {
            self.foreThirdColor  = hexToColor(hex: "#ebebeb") // 背景色
            self.foreSecondColor = hexToColor(hex: "464646") // 盘色
            self.foreThirdColor = hexToColor(hex: "e1e1e1") // 指针色
