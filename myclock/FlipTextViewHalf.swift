...
//          ArialRoundedMTBold
//          Bebas Neue
              .font(Font.custom("Bebas Neue", size: config.fontSize))
//         .font(Font.custom("Bebas Neue", size: config.fontSize))
...
//          .background(config.backgroundColor, in: backgroundShape)
          .background(config.backgroundColor, in: backgroundShape)
//          .background(Color.clear, in: backgroundShape)
...
//          .background(Color.clear, in: backgroundShape)
    ...
    .font(font)
//    .foregroundColor(themeManager.themeTextColor)
